...
public:
    ...
    Configurations::BoolOption queryPerOptimizationStage
        = {"queryPerOptimizationStage",
           "false",
           "Creates and runs a query per stage of Nebuli's QueryRewritePhase per original query. Will only work when benchmark is set to "
           "true"};
